        ...
        <div className={ cls.ProfileContainer }>
            <div className={ cls.FlexContainer }>
                ...
                { isLoading
                    ...
                    : <div>
                        <InputCustom onChange={EditName} readonly={readOnly} value={name} state={InputState.RESETINPUT}></InputCustom>
                        <InputCustom onChange={EditLastName} readonly={readOnly} value={lastname} state={InputState.RESETINPUT}></InputCustom>
                    </div>
                }
